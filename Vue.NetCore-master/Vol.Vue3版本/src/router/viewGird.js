...
let viewgird = [
  ...
  , {
    ...
    component:  () => import('@/views/appmanager/App_NewsEditor.vue' )
      ...
      path: '/DocumentManagementList', //二级表头
      name: 'DocumentManagementList',
      component:  () => import('@/views/documentManagement/DocumentManagementList.vue' )
    }, {
      path: '/DocumentManagementInput', //二级表头
      name: 'DocumentManagementInput',
      component:  () => import('@/views/documentManagement/DocumentManagementInput.vue' )
    }]
