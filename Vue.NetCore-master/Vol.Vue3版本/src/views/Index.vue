<template>
  <div id="vol-container" :class="['vol-theme-' + theme]">
    <div class="vol-aside" :style="{ width: menuWidth + 'px' }">
      <div class="header" :style="{ width: menuWidth - 1 + 'px' }" style="background-color: white;">
        <img v-show="!isCollapse" v-bind:src="logo" />
        <i @click="toggleLeft" class=" collapse-menu" :class="isCollapse?'el-icon-s-unfold':'el-icon-s-fold'" style="color: #2d8cf0;" />
      </div>
      <div class="vol-menu">
