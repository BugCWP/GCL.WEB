<template>
  <div class="login-container">
    <div class="project-name" style="display:flex;align-items: center;">
      <img v-bind:src="logo" style="width: 130px;"/>
      <div style="color: #2a71b9;margin-left: 10px;">
        <div>协鑫绿能系统科技有限公司</div>
        <div style="font-size: 15px">GCL Green Energy System Technology Co.,Ltd</div>
    </div>
    </div>
    ...
    <img class="login-bg" src="/static/login_bg.jpg" style="object-fit:cover"/>
  </div>
</template>
